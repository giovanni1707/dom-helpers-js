...
(function (global) {
  ...
  const classesSetter = (el, operations) => {
    if (typeof operations === "string") {
      ...
      if (operations.add) {
        const addList = Array.isArray(operations.add)
          ? operations.add
          : [operations.add];
        el.classList.add(...addList);
      }
      if (operations.remove) {
        const removeList = Array.isArray(operations.remove)
          ? operations.remove
          : [operations.remove];
        el.classList.remove(...removeList);
      }
      if (operations.toggle) {
        const toggleList = Array.isArray(operations.toggle)
          ? operations.toggle
          : [operations.toggle];
      ...
      if (
        operations.replace &&
        Array.isArray(operations.replace) &&
        operations.replace.length === 2
      ) {
  ...
  function addEventListenerOnce(element, eventType, handler, options) {
    ...
    if (!handlersForEvent.has(handlerKey)) {
      ...
      handlersForEvent.set(handlerKey, { handler: handler, options: options });
    }
  }
      ...
      try {
        ...
        if (element && element.nodeType === Node.ELEMENT_NODE) {
          if (typeof element.update === "function") {
            ...
            results[elementId] = { success: true, element: element };
        ...
        results[elementId] = { success: false, error: error.message };
        failed.push(elementId);
      }
    });
  ...
  Collections.update = (updates = {}) => {
    ...
    Object.entries(updates).forEach(([identifier, updateData]) => {
      try {
        ...
        results[identifier] = { success: false, error: error.message };
        failed.push(identifier);
      }
    });
    if (CollectionHelper.options.enableLogging) {
      const totalElements = successful.reduce(
        (sum, id) => sum + (results[id].elementsUpdated || 0),
        0
      );
      console.log(
  ...
  Selector.update = (updates = {}) => {
    ...
    if (SelectorHelper.options.enableLogging) {
      const totalElements = successful.reduce(
        (sum, sel) => sum + (results[sel].elementsUpdated || 0),
        0
      );
      console.log(
    ...
    function createElementsBulk(definitions = {}) {
      ...
      Object.entries(definitions).forEach(([tagName, config]) => {
        try {
          ...
          elementsList.push({ key: tagName, element: element });
        } catch (error) {
          console.warn(
      ...
      return {
        ...
        map(callback) {
          return elementsList.map(({ key: key, element: element }, index) =>
            callback(element, key, index)
          );
        },
        filter(callback) {
          return elementsList
            .filter(({ key: key, element: element }, index) =>
              callback(element, key, index)
            )
...
(function (global) {
  ...
  function createBulkPropertyUpdater(propertyName, transformer = null) {
    return function (updates = {}) {
      if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
        console.warn(
          `[DOM Helpers] ${propertyName}() requires an object with element IDs as keys`
        );
        return this;
      }
      Object.entries(updates).forEach(([elementId, value]) => {
        try {
          ...
          if (element && element.nodeType === Node.ELEMENT_NODE) {
            ...
            console.warn(
              `[DOM Helpers] Element '${elementId}' not found for ${propertyName} update`
            );
          }
        } catch (error) {
          console.warn(
            `[DOM Helpers] Error updating ${propertyName} for '${elementId}': ${error.message}`
          );
        }
      });
      return this;
  ...
  function createBulkStyleUpdater() {
    return function (updates = {}) {
      if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
        console.warn(
          "[DOM Helpers] style() requires an object with element IDs as keys"
        );
        return this;
      }
        ...
        try {
          ...
          if (element && element.nodeType === Node.ELEMENT_NODE) {
            if (typeof styleObj !== "object" || styleObj === null) {
              console.warn(
                `[DOM Helpers] style() requires style object for '${elementId}'`
              );
              return;
            }
            if (element.update && typeof element.update === "function") {
            ...
            console.warn(
              `[DOM Helpers] Element '${elementId}' not found for style update`
            );
          }
        } catch (error) {
          console.warn(
            `[DOM Helpers] Error updating style for '${elementId}': ${error.message}`
          );
        }
      });
      return this;
  ...
  function createBulkDatasetUpdater() {
    return function (updates = {}) {
      if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
        console.warn(
          "[DOM Helpers] dataset() requires an object with element IDs as keys"
        );
        return this;
      }
        ...
        try {
          ...
          if (element && element.nodeType === Node.ELEMENT_NODE) {
            if (typeof dataObj !== "object" || dataObj === null) {
              console.warn(
                `[DOM Helpers] dataset() requires data object for '${elementId}'`
              );
              return;
            }
            if (element.update && typeof element.update === "function") {
            ...
            console.warn(
              `[DOM Helpers] Element '${elementId}' not found for dataset update`
            );
          }
        } catch (error) {
          console.warn(
            `[DOM Helpers] Error updating dataset for '${elementId}': ${error.message}`
          );
        }
      });
      return this;
  ...
  function createBulkAttributesUpdater() {
    return function (updates = {}) {
      if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
        console.warn(
          "[DOM Helpers] attrs() requires an object with element IDs as keys"
        );
        return this;
      }
        ...
        try {
          ...
          if (element && element.nodeType === Node.ELEMENT_NODE) {
            if (typeof attrsObj !== "object" || attrsObj === null) {
              console.warn(
                `[DOM Helpers] attrs() requires attributes object for '${elementId}'`
              );
              return;
            }
            ...
            console.warn(
              `[DOM Helpers] Element '${elementId}' not found for attrs update`
            );
          }
        } catch (error) {
          console.warn(
            `[DOM Helpers] Error updating attrs for '${elementId}': ${error.message}`
          );
        }
      });
      return this;
  ...
  function createBulkClassListUpdater() {
    return function (updates = {}) {
      if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
        console.warn(
          "[DOM Helpers] classes() requires an object with element IDs as keys"
        );
        return this;
      }
      Object.entries(updates).forEach(([elementId, classConfig]) => {
        try {
          ...
          if (element && element.nodeType === Node.ELEMENT_NODE) {
            ...
            console.warn(
              `[DOM Helpers] Element '${elementId}' not found for classes update`
            );
          }
        } catch (error) {
          console.warn(
            `[DOM Helpers] Error updating classes for '${elementId}': ${error.message}`
          );
        }
      });
      return this;
  ...
  function createBulkGenericPropertyUpdater() {
    return function (propertyPath, updates = {}) {
      if (typeof propertyPath !== "string") {
        console.warn(
          "[DOM Helpers] prop() requires a property name as first argument"
        );
        return this;
      }
      if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
        console.warn(
          "[DOM Helpers] prop() requires an object with element IDs as keys"
        );
        return this;
      }
          ...
          if (element && element.nodeType === Node.ELEMENT_NODE) {
            if (isNested) {
              ...
              for (let i = 0; i < pathParts.length - 1; i++) {
                ...
                if (!obj) {
                  console.warn(
                    `[DOM Helpers] Invalid property path '${propertyPath}' for '${elementId}'`
                  );
                  return;
                }
              }
              ...
              if (propertyPath in element) {
                ...
                console.warn(
                  `[DOM Helpers] Property '${propertyPath}' not found on element '${elementId}'`
                );
              }
            }
          } else {
            console.warn(
              `[DOM Helpers] Element '${elementId}' not found for prop update`
            );
          }
        } catch (error) {
          console.warn(
            `[DOM Helpers] Error updating prop '${propertyPath}' for '${elementId}': ${error.message}`
          );
        }
      });
      return this;
  ...
  function enhanceCollectionInstance(collectionInstance) {
    ...
    const createIndexBasedUpdater = (propertyName, transformer = null) =>
      function (updates = {}) {
        if (!updates || typeof updates !== "object" || Array.isArray(updates)) {
          console.warn(
            `[DOM Helpers] ${propertyName}() requires an object with numeric indices as keys`
          );
          return this;
        }
        Object.entries(updates).forEach(([index, value]) => {
          try {
            ...
            console.warn(
              `[DOM Helpers] Error updating ${propertyName} at index ${index}: ${error.message}`
            );
          }
        });
        return this;
      ...
      function (updates = {}) {
        Object.entries(updates).forEach(([index, styleObj]) => {
          try {
            ...
            console.warn(
              `[DOM Helpers] Error updating style at index ${index}: ${error.message}`
            );
          }
        });
        return this;
      ...
      function (updates = {}) {
        Object.entries(updates).forEach(([index, dataObj]) => {
          try {
            ...
            console.warn(
              `[DOM Helpers] Error updating dataset at index ${index}: ${error.message}`
            );
          }
        });
        return this;
      ...
      function (updates = {}) {
        Object.entries(updates).forEach(([index, classConfig]) => {
          try {
            ...
            console.warn(
              `[DOM Helpers] Error updating classes at index ${index}: ${error.message}`
            );
          }
        });
        return this;
  ...
  if (
    typeof global.Elements !== "undefined" ||
    typeof global.Collections !== "undefined"
  ) {
